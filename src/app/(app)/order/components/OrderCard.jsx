        ...
        <div className="bg-white rounded-2xl px-4 py-4 shadow-md">
            <div className="flex justify-between items-top">
                <div className="flex gap-2 items-top">
                    <div className="bg-green-500 rounded-lg p-4 font-bold text-white">KLT</div>
                    <div className="flex flex-col">
                        <h1 className="text-xs font-bold max-w-36 text-nowrap overflow-hidden">AGUS BNTG</h1>
                        <h1 className="text-xs text-slate-500">KLT-123</h1>
                        <h1 className="text-xs text-slate-500">SAMSUNG GALAXY A55</h1>
                    </div>
                </div>
                <span className="px-2 py-1 bg-yellow-500 text-white text-xs h-fit rounded-md">Pending</span>
            </div>
            <div className="flex justify-between items-center mt-2">
                <h1 className="text-xs font-bold text-slate-700">Rabu, 28 Feb 2023 10:00 WIB</h1>
            </div>
            ...
            <div className="mt-4">
                <div className="flex justify-between">
                    <h1 className="text-xs font-semibold text-slate-700">Total</h1>
                    <h1 className="text-xs font-semibold text-slate-700">Rp. 4.000.000</h1>
                </div>
                <div className="grid grid-cols-2 gap-2 mt-4">
                    <button className="rounded-2xl px-6 py-3 bg-slate-300 hover:bg-slate-200 border">Detail</button>
                    <button className="rounded-2xl px-6 py-3 bg-blue-700 hover:bg-blue-600 text-white border">Pay</button>
                </div>
            </div>
        </div>
    );
